...
abstract final class AppTextStyles {
  ...
  static const boldSmall = TextStyle(fontSize: 14, fontWeight: FontWeight.bold);
  ...
  static const boldLarge = TextStyle(fontSize: 18, fontWeight: FontWeight.bold);
  ...
  static const errorText = TextStyle(color: AppColors.redColor);
}
